...
#define RT_FORMAT_RGB	3	/* XBGR or BGR instead of (X)RGB */
#define RT_SIMPLE_RLE   9       /* simple rle format - not sun compatible */
 ...
 */
 ...
 void sunras_read(int fd, int depth, int w, int h, void *b);
 void sunras_write(int fd, int depth, int w, int h, void *b);
